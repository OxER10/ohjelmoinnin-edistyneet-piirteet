...
class Kalenterimerkinta : Paivays {
    ...
    public:
        Kalenterimerkinta();
        Kalenterimerkinta(const Paivays tempPaivays, std::string tempAsia, bool tempMuistutus);
        Kalenterimerkinta( const Kalenterimerkinta &obj);
        ~Kalenterimerkinta();
        void setPaivays(const Paivays uusiPaivays);
