...
Kalenterimerkinta::Kalenterimerkinta(const Paivays tempPaivays, std::string tempAsia, bool tempMuistutus) {
    paivays = tempPaivays;
    asia = tempAsia;
    muistutus = tempMuistutus;
}
Kalenterimerkinta::Kalenterimerkinta( const Kalenterimerkinta &obj) {
    Paivays temp(3, 4, 2025);
    paivays = temp;
    asia = obj.asia;
    muistutus = obj.muistutus;
}
...
void Kalenterimerkinta::setPaivays(const Paivays uusiPaivays) {
    paivays = uusiPaivays;
}
...
void doSomethingArvoparametri(Kalenterimerkinta aKalenterimerkinta) {
    std::cout << "Arvoparam. Ennen muutosta:" << aKalenterimerkinta.getAsia() << "\n";
    aKalenterimerkinta.setAsia("Vaihdettu asia");
    std::cout << "Arvoparam. Jalkeen muutoksen:" << aKalenterimerkinta.getAsia() << "\n";
}

void doSomethingViittausparametri(Kalenterimerkinta &aKalenterimerkinta) {
    std::cout << "Viittausparam. Ennen muutosta:" << aKalenterimerkinta.getAsia() << "\n";
    aKalenterimerkinta.setAsia("Vaihdettu asia");;
    std::cout << "Viittausparam. Jalkeen muutoksen:" << aKalenterimerkinta.getAsia() << "\n";
}
